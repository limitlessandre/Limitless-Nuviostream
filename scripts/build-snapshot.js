...
if (prior) fs.writeFileSync(path.join(root, 'src', 'fallback-snapshot.mjs'), `// Generated last-known-good snapshot.\nexport const fallbackSnapshot = ${JSON.stringify(prior, null, 2)};\n`);
...
fs.writeFileSync(path.join(root, 'src', 'snapshot.mjs'), `// Generated by scripts/build-snapshot.js. Do not edit manually.\nexport const snapshot = ${JSON.stringify(candidate, null, 2)};\n`);

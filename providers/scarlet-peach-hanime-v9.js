...
async function getMetadata(inputId, episode, mediaType) {
  return await getScarletMeta(inputId, episode) || await getExternalMeta(inputId, mediaType);
}
...
async function getStreams(inputId, mediaType, season, episode) {
  try {
    ...
    const meta = await getMetadata(inputId, ep, mediaType);

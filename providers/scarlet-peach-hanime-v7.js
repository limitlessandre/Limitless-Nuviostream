...
function audioVariantTag(meta) {
  ...
  // Hanime's current catalog/search payload does not expose audio/subtitle
  // fields, while the site presents its standard guest releases as Japanese
  // audio with English subtitles. Keep this as presentation-only fallback:
  // explicit metadata above always overrides it and Scarlet Peach canonical
